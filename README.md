...
![Status](https://img.shields.io/badge/Status-Live-3ddc97)

**Live demo:** [hotelanalysis-86tpktzddbi7kzt3dmd4un.streamlit.app](https://hotelanalysis-86tpktzddbi7kzt3dmd4un.streamlit.app/)
...
Hotel Analytics investigates hotel booking and cancellation behavior for a
hotel business, answering three core business questions from raw booking
data: which hotel type is booked most often, whether length of stay
affects cancellation rate, and whether lead time (the gap between booking
and arrival) affects cancellation rate. The cleaned dataset also powers a
live, trained machine learning model that predicts cancellation risk for
any hypothetical booking.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/ubai756/Hotel_analysis.git
   cd Hotel_analysis
   ```
...
Visit: [hotelanalysis-86tpktzddbi7kzt3dmd4un.streamlit.app](https://hotelanalysis-86tpktzddbi7kzt3dmd4un.streamlit.app/)
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for coding style, testing
expectations, and more detail.
...
**ubai756** — Hotel Analytics Developer

- GitHub: [@ubai756](https://github.com/ubai756)
- Email: ubaisnip756@gmail.com
- Project: [Hotel_analysis Repository](https://github.com/ubai756/Hotel_analysis)
- Live app: [hotelanalysis-86tpktzddbi7kzt3dmd4un.streamlit.app](https://hotelanalysis-86tpktzddbi7kzt3dmd4un.streamlit.app/)

---

## Acknowledgments

- **Dataset:** Hotel bookings dataset, 2017–2019, ~119K records
- **Framework:** Streamlit for the interactive dashboard
- **ML:** Scikit-learn Gradient Boosting implementation
- **Visualization:** Plotly for interactive, themed charts
